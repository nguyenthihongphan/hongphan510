...
<br>
<h3 style="margin-left:450px; color:#C00">CHỈ SINH VIÊN ĐƯỢC GIẢNG VIÊN CẤP MẬT KHẨU MỚI CÓ QUYỀN TRUY CẬP</h3>
<br>
 <div class="grid">
	  ...
	  case 'Đăng nhập':
	  {
		  ...
		  if($pass!='')
		  {
		 ...
		 else
			{
				...
				echo'Vui lòng nhập mật khẩu giảng viên cung cấp'; 
				}
		  break;
		  }
	  }
