...
$iduser=$_SESSION['id'];
$layid_hd = $_SESSION['id'];
$ten=$q->luachon("select ten from taikhoan where id='$iduser' limit 1");
$tenbaocao=$q->luachon("select id from baocao where idhd='$layid_hd'");
?>
...
<head>
     ...
     <title>Nộp báo cáo hoạt động ngoại khóa</title>
...
<br>
 <p></p> <br>
         <p class="text-gray font-weight-bold text-uppercase px-3 small pb-4 mb-0" style="font-size:18px; border-bottom: 1px solid #000; margin-left:50px">Phát triển ứng dụng(420300350102)/<b style="color:#C00">Nộp báo cáo HOẠT ĐỘNG NGOẠI KHÓA</b></p>
         <br><br>
 <div class="grid">

	<h3 style="margin-left:450px; color:#C00">NỘP BÁO CÁO HOẠT ĐỘNG NGOẠI KHÓA</h3>
    <br>
    ...
    <th style="text-align:center"><form method="post" action="" enctype='multipart/form-data'>
    <input type='file' name='file' />
    <?php require 'action.php';?>
   <input type='submit' value="Thêm bài nộp" name='upload' class="upload" >
    </form></th>
  	</tr>
    <tr>
</table>
...
<br>
 <p align="center"><a href="ptud.php"><button type="button">Hoàn thành và kết thúc</button></a></p>
