...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
 ...
 <p class="text-gray font-weight-bold text-uppercase px-3 small pb-4 mb-0" style="font-size:18px; border-bottom: 1px solid #000; margin-left:50px">Phát triển ứng dụng(420300350102)/File nộp báo cáo</p>
         <br><br>
  <div class="row">
                    <!-- column -->
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        <h4 class="card-title">File báo cáo đã nộp</h4>
                                        <h5 class="card-subtitle"><input class=" shadow-none" type="text" style="font-size:16px" placeholder="Tìm tiếm"  value ="<?php if(isset($_POST["timkiem"])){echo $_POST ["timkiem"];} ?>" /> <a style="margin-left:-30px" class=" waves-effect waves-dark"
                                href="javascript:void(0)"><i class="ti-search"></i></a>
                            
                        </h5>
                                    </div>
                                    </div>
<div class= "hide-menu m-l-5 col-md-4" >
<p> Tên hoạt động báo cáo</p>
<table>
<?php


$p->load_ds_hd("select * from hoatdong order by id desc");

?>
</table>
</div>
<div class="baocao" class="table-responsive col-md-8" >
<?php
$timkiem='';
...
;
	if($layid_hd >0)
	{	$p->load_ds_baocao("select * from baocao where idhd='$layid_hd' order by ten asc");
		}
	else
	{	$p->load_ds_baocao("select * from baocao order by date asc");
		}
