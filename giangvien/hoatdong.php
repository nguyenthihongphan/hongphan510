...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
 ...
 <p class="text-gray font-weight-bold text-uppercase px-3 small pb-4 mb-0" style="font-size:18px; border-bottom: 1px solid #000; margin-left:50px">Phát triển ứng dụng(420300350102)/Hoạt động ngoại khóa</p>
         <br><br>
  <div class="row">
                    <!-- column -->
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        <h4 class="card-title">Danh sách hoạt động ngoại khóa</h4>
...
<table class="table v-middle">
	<thead>
        ...
        <th class="border-top-0">Tên hoạt động</th>
        <th class="border-top-0">Nội dung</th>
        <th class="border-top-0">Hạn nộp </th>
...
<?php
	...
	//in danh sách hoạt động ngoại khóa
	$dem=1;
...
?>
	<tr>
		<td> <h4 class="m-b-0 font-16"><?php echo $dem?></h4></td>
        <td><h4 class="m-b-0 font-16"><?php echo $tenhd?></h4></td>
        <td><h4 class="m-b-0 font-16"><?php echo $noidung?></h4></td>
        <td><h4 class="m-b-0 font-16"><?php echo $han?></h4></td>  
        <td><h4 class="m-b-0 font-16">
        	<a href="sua.php?id=<?php echo $id;?>" class="btn btn-dark">Sửa </a>
            <a href="xulyxoahdnk.php?id=<?php echo $id;?>" class="btn btn-danger"> Xóa</a></h4></td>
     </tr>
     <?php
	 $dem++;	
	}
	...
	mysqli_close($conn);?>
    <tr>
    	<td colspan="6" align="center"><button type="button" onClick="myFunction()" class="btn btn-primary"> Thêm mới</button></td>
    </tr>
 </table> 
 </div> 
 </div>  
...
<script>
	function myFunction(){
		location.replace("themhdnk.php");// điều hướng đến trang thêm dữ liệu
	}
</script>