...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
 ...
 <p class="text-gray font-weight-bold text-uppercase px-3 small pb-4 mb-0" style="font-size:18px; border-bottom: 1px solid #000; margin-left:50px">Phát triển ứng dụng(420300350102)/Phát biểu</p>
         <br><br>
  <div class="row">
                    <!-- column -->
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        <h4 class="card-title">Danh sách sinh viên phát biểu</h4>
...
<br>
<br>
<h3 style="margin-left:20px">Danh sách sinh viên</h3>
<br>
  <table>
    <?php
$p->load_sv("select * from sinhvien order by id desc")
?>
</table>
