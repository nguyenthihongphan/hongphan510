...
<head>
    ...
    <title>Thêm hoạt động ngoại khóa</title>
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
 ...
 <p class="text-gray font-weight-bold text-uppercase px-3 small pb-4 mb-0" style="font-size:18px; border-bottom: 1px solid #000; margin-left:50px">Phát triển ứng dụng(420300350102)/Hoạt động ngoại khóa/ Thêm Hoạt động ngoại khóa</p>
     ...
     <form action="xulythemhdnk.php" method="post" enctype="multipart/form-data" name="form1" id="form1"  class="form-horizontal form-material mx-2">
    <div class="form-group">
    
     <label class="col-md-12">Tên hoạt động</label>
           <div class="col-md-12">
              <input type="text" id="tenhd" name="tenhd" value="" size="30"class="form-control form-control-line">
               </div>
        </div>
             <div class="form-group">
              <label class="col-md-12">Nội dung</label>
              <div class="col-md-12">
            <textarea rows="5" class="form-control form-control-line" id="noidung" name="noidung"></textarea>
            </div>
         	</div>
            <div class="form-group">
              <label class="col-md-2">Hạn nộp</label>
              <div class="col-md-3">
             <input <input type="date" id="han" name="han" value="" size="30"class="form-control form-control-line">
               </div>
            </div>
         	 <div class="form-group">
              <div class="col-md-3">
             <input type="submit" id="tbtnSave" name="btnSave" value="Thêm"class="form-control form-control-line btn btn-primary">
               </div>
            </div>
